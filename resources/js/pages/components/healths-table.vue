                               ...
                               <div class="row" v-for="(heath_drug,index) in temp.drugs_health">
                                   ...
                                   <div class="col-3">
                                       <div class="form-group">
                                           ...
                                           <input v-model="heath_drug.quantum" type="number" class="form-control">
                                       </div>
                                   </div>
                                   <div class="col-1">
                                       <div class="form-group">
                                ...
                                <div class="form-group" v-if="action == 'create'">
                                    ...
                                    <input type="text" class="form-control" v-model="temp.lecturer_id"  placeholder="Điền ID người bệnh">
                                </div>
                            </div>
                        </div>
                        <div class="row" v-if="loading">
